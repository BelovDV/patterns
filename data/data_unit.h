...
namespace Unit
{
	...
	std::string const Info::description = "lvl att def dmin dmax hp spd init being costA costB costC";
	std::string const Data::description = "id race name " + Info::description;
